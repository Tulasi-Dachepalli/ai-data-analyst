...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    // Anthropic call that already happened, and the whole point of this
    // table is to be a reliable usage/billing record — better to add a
    // few ms than to risk silently losing rows if the process restarts
    // right after responding.
