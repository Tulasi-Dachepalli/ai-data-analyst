...
export const ROLE_CONFIGS = {
  ...
  data_scientist: {
    ...
    navigation: [
      { id: "raw_data", label: "01 Raw Data", icon: "📁", category: "DATA" },
      { id: "profile", label: "02 Data Profile", icon: "🧪", category: "DATA" },
      { id: "quality", label: "03 Data Quality", icon: "🩺", category: "DATA" },
      { id: "cleaning", label: "04 Data Cleaning", icon: "🧹", category: "DATA" },
      { id: "cleaned_data", label: "05 Cleaned Data", icon: "✨", category: "DATA" },
      { id: "eda", label: "06 EDA", icon: "🔍", category: "UNDERSTAND" },
      { id: "relationships", label: "07 Relationships", icon: "🔗", category: "UNDERSTAND" },
      { id: "stats", label: "08 Statistics", icon: "📈", category: "UNDERSTAND" },
      { id: "visual_studio", label: "09 Visualization", icon: "📊", category: "UNDERSTAND" },
      { id: "feature_eng", label: "10 Feature Engineering", icon: "⚡", category: "ENGINEER" },
      { id: "ml", label: "11 ML Modeling", icon: "🤖", category: "MODEL" },
      { id: "evaluation", label: "12 Model Evaluation", icon: "📐", category: "MODEL" },
      { id: "predictions", label: "13 Predictions", icon: "🎯", category: "MODEL" },
      { id: "forecast", label: "14 Forecasting", icon: "🔮", category: "ADVANCED" },
      { id: "anomalies", label: "15 Anomaly Detection", icon: "🚨", category: "ADVANCED" },
      { id: "whatif", label: "16 What-If Analysis", icon: "🎛️", category: "ADVANCED" },
      { id: "ai_copilot", label: "17 AI Data Scientist", icon: "💬", category: "AI" },
      { id: "investigate", label: "18 AI Investigation", icon: "🔬", category: "AI" },
      { id: "experiments", label: "19 Experiments", icon: "🧪", category: "EXPERIMENT" },
      { id: "registry", label: "20 Model Registry", icon: "🏢", category: "EXPERIMENT" },
      { id: "insights", label: "21 Business Insights", icon: "💡", category: "OUTPUT" },
      { id: "reports", label: "22 Executive Reports", icon: "📑", category: "OUTPUT" }
    ],
    kpiCards: [
